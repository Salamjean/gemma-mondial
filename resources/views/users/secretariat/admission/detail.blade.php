...
@php
    ...
    } elseif ($admission->infirmier && $admission->infirmier->user) {
                    ...
                    <table class="table table-borderless align-middle mb-0">
                        <tbody>
                            <tr class="border-bottom">
                                ...
                                <td class="py-3 fs-14 fw-bold text-dark">{{ $admission->type_admission ?? 'Consultation' }}</td>
                            </tr>
                            <tr class="border-bottom">
                ...
                <div class="p-20 bg-light rounded-16 border h-100 d-flex flex-column justify-content-between">
                    <div>
                        ...
                        <p class="fs-15 text-dark lh-base mb-0" style="white-space: pre-line;">
                            {{ $admission->motif_consultation ?: 'Aucun motif de consultation particulier spécifié lors de l\'enregistrement.' }}
                        </p>
                    </div>
