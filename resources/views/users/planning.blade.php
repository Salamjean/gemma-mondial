@extends('layouts.dashboard', ['title' => $title ?? 'Votre planning'])
    ...
    <div class="d-md-flex align-items-center justify-content-between">
        <div>
            <h3 class="mb-5 text-white font-weight-bold" style="font-size: 22px;">
                <i class="fa-solid fa-calendar-days me-10" style="color: #64b5f6;"></i>Mon Planning & Horaires de Service
            </h3>
            <span class="text-white-50" style="font-size: 14px;">Consultez vos jours de garde, vos tranches horaires et votre calendrier d'activité.</span>
        </div>
        <div class="mt-15 mt-md-0">
            <span class="badge bg-white text-primary px-15 py-10 fs-14 rounded-pill font-weight-bold shadow-sm me-10">
                <i class="fa-solid fa-user-clock me-5"></i> {{ $user->name ?? auth()->user()->name }} {{ $user->prenom ?? auth()->user()->prenom }} ({{ ucfirst(auth()->user()->role_as ?? 'Personnel') }})
            </span>
    ...
    <div class="col-xl-3 col-lg-6 col-12">
        <div class="box bg-success-light" style="border-left: 5px solid #09bb86; border-radius: 8px;">
            <div class="box-body text-center">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="p-5">
                        <i class="fa-solid {{ $isWorkingToday ? 'fa-user-check' : 'fa-moon' }} text-success" style="font-size: 36px;"></i>
                    </div>
                    <div class="text-end">
                        @if ($isWorkingToday)
        ...
        <div class="box bg-warning-light" style="border-left: 5px solid #ffc107; border-radius: 8px;">
            <div class="box-body text-center">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-end">
                        <h2 class="mb-0 font-weight-bold text-warning fs-20">Permanence</h2>
                        <p class="text-fade mt-5 mb-0 text-warning font-weight-bold">Service régulier</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="box">
    <div class="box-header" style="background-color: #f4f6f9; border-bottom: 2px solid #e9ecef; padding: 15px 20px;">
        <h4 class="box-title text-dark font-weight-bold mb-0">
            <i class="fa-solid fa-calendar-week me-10 text-primary"></i>Planning Hebdomadaire • Détail des Jours
        </h4>
    </div>
    <div class="box-body">
        <div class="row">
                        ...
                        <div class="box-body p-15">
                            ...
                            @if ($isWorking)
                                ...
                                <small class="text-muted fs-12 d-block text-center">
                                    <i class="fa-solid fa-building-user me-5 text-primary"></i> Service Hôpital
                                </small>
                            @else
    ...
    <div class="box-header" style="background-color: #f4f6f9; border-bottom: 2px solid #e9ecef; padding: 15px 20px;">
        <div class="d-md-flex justify-content-between align-items-center">
            ...
            <div class="mt-10 mt-md-0 fs-13">
                <span class="me-15">
                    <span class="d-inline-block rounded-circle" style="width: 12px; height: 12px; background-color: #09bb86;"></span> Jours de Permanence
                </span>
                <span>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            eventClick: function(info) {
                if (info.event.extendedProps.type === 'rendezVous' && info.event.extendedProps.url) {
