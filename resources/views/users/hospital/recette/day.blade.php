@extends('layouts.dashboard', ['title' => 'Recette de l\'hôpital du ' . dateCompletFr($day)])
            ...
            <div class="box-header with-border">
                <div class="row align-items-center">
                    <div class="col-md-8 col-12">
                        <h4 class="box-title">
                            <b>RECETTES DE L'ÉTABLISSEMENT : {{ strtoupper(dateCompletFr($day)) }}</b>
                        </h4>
                    </div>
                    <div class="col-md-4 col-12 text-md-end text-start mt-2 mt-md-0">
                        <a href="{{ route('hospital.recette.list') }}" class="btn btn-sm btn-secondary">
                            <i class="fa-solid fa-list me-1"></i> Toutes les dates
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="box-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <small class="text-white-50">{{ count($payments) }} acte(s) au total</small>
                    </div>
                    <div>
            ...
            <div class="box-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <small class="text-muted">Part couverte par les assurances</small>
                    </div>
                    <div>
...
{{-- RECAPITULATIF PAR CAISSIERE --}}
<div class="row">
    <div class="col-12">
        <div class="box">
            <div class="box-header with-border">
                <h4 class="box-title"><b>RÉPARTITION PAR CAISSIÈRE</b></h4>
            </div>
            <div class="box-body">
                <div class="table-responsive">
                    <table class="table table-striped table-hover display nowrap margin-top-10 w-p100">
                        <thead class="bg-primary">
                            <tr>
                                ...
                                <th class="bb-2 text-end">Total Encaissé</th>
                                <th class="bb-2 text-center">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            @forelse ($caissieres as $item)
                                <tr>
                                    <td><b>{{ $item->matricule }}</b></td>
                                    <td><i>{{ $item->name }} {{ $item->prenom }}</i></td>
                                    <td class="text-center">
                                        <b>{{ $item->nb }}</b>
                                    </td>
                                    <td class="text-end">
                                        <b class="text-success">{{ number_format($item->sum_espece ?? 0, 0, ',', ' ') }} FCFA</b>
                                    </td>
                                    <td class="text-end">
                                        <b class="text-primary">{{ number_format($item->sum_mobile_money ?? 0, 0, ',', ' ') }} FCFA</b>
                                    </td>
                                    <td class="text-end">
                                        <b>{{ number_format($item->sum ?? 0, 0, ',', ' ') }} FCFA</b>
                                    </td>
                                    <td class="text-center">
                                        <a href="{{ route('hospital.recette.detail', ['day' => $day, 'id' => $item->caissiere_id]) }}" class="btn btn-sm btn-info">
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="text-center text-muted py-3">Aucun encaissement pour cette date</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
...
{{-- TRANSACTIONS INDIVIDUELLES DE LA JOURNEE --}}
<div class="row">
    <div class="col-12">
        <div class="box">
            <div class="box-header with-border">
                <h4 class="box-title"><b>TOUTES LES TRANSACTIONS DE LA JOURNÉE</b></h4>
            </div>
            <div class="box-body">
                <div class="table-responsive">
                        ...
                        <tbody>
                            @foreach ($payments as $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <i>{{ $item->cashier->user->name ?? 'Caissière' }}</i>
                                    </td>
                                    <td>
                                        <b>{{ $patientCode }}</b>
                                    </td>
