            ...
            <div class="box-header with-border">
                <div class="row align-items-center">
                    <div class="col-md-8 col-12">
                        <h4 class="box-title">
                            <b>HISTORIQUE & SUIVI DES RECETTES</b>
                        </h4>
                    </div>
                    <div class="col-md-4 col-12 text-md-end text-start mt-2 mt-md-0">
                        <a href="{{ route('cashier.recette.day', date('Y-m-d')) }}" class="btn btn-sm btn-primary">
...
{{-- CARTES DE SYNTHÈSE GLOBALE SANS BORDURES COLOREES --}}
<div class="row">
            ...
            <div class="box-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <small class="text-white-50">{{ $consultations->count() }} journée(s) d'activité</small>
                    </div>
                    <div>
            ...
            <div class="box-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <small class="text-muted">{{ $pourcentEspece }}% du total</small>
                    </div>
                    <div>
            ...
            <div class="box-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <small class="text-muted">{{ $pourcentMobile }}% du total</small>
                    </div>
                    <div>
            ...
            <div class="box-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <small class="text-muted">Encaissements validés</small>
                    </div>
                    <div>
...
<div class="row">
    <div class="col-12">
        <div class="box">
            <div class="box-header with-border">
                <h4 class="box-title"><b>JOURNAL DES RECETTES PAR DATE</b></h4>
            </div>
            <div class="box-body">
                        ...
                        <tbody>
                            @foreach ($consultations as $item)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('cashier.recette.day', $item->jour) }}" class="btn btn-sm btn-primary me-1" title="Voir le détail">
                                            <i class="fa-solid fa-eye me-1"></i> Détails
                                        </a>
                                        <a href="{{ route('cashier.admission.indicate', $item->jour) }}" target="_blank" class="btn btn-sm btn-secondary" title="Imprimer le point PDF">
